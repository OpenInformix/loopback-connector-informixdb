...
Thank you for your interest in `loopback-connector-informixdb`, an open source project
administered by StrongLoop (an IBM Company).

Contributing to `loopback-connector-informixdb` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/loopback-connector-informixdb)
